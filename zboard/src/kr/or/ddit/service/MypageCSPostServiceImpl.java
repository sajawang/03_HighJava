...
import kr.or.ddit.dao.MypageCSPostDaoImpl;
import kr.or.ddit.dao.IMypageCSPostDao;
import kr.or.ddit.vo.CommentVO;
import kr.or.ddit.vo.FileVO;
import kr.or.ddit.vo.PageVO;
import kr.or.ddit.vo.PostVO;

public class MypageCSPostServiceImpl implements IMypageCSPostService {
	
	private IMypageCSPostDao dao;
	private static MypageCSPostServiceImpl service;
	
	private MypageCSPostServiceImpl() {
		dao = MypageCSPostDaoImpl.getInstance();
	}
	public static MypageCSPostServiceImpl getInstance() {
		if(service==null) service= new MypageCSPostServiceImpl();
		return service;
	}
