 ...
 * 관리자 이용문의 게시판 리스트 출력
 */
@WebServlet("/adminMymathBoardList.do")
public class AdminMymathBoardList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/view/adminmymathboard/adminmymathboardList.jsp").forward(request, response);
	}
