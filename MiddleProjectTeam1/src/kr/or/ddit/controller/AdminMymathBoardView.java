...
/**
 * 관리자 수학학습해결소 해당 게시글 상세보기 서블릿
 */
@WebServlet("/adminMymathBoardView.do")
public class AdminMymathBoardView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/view/adminmymathboard/adminmymathboardView.jsp").forward(request, response);
	}
