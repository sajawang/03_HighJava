...
public interface IAdmUserDao {
	 ...
	 */
	public CustomerVO detailUser(String memId);
	 ...
	 */
	public int insertUser(CustomerVO vo);
	 ...
	 * @return 작업 성공 : 1, 작업 실패 : 0
	 */
	public int updateUser(CustomerVO vo);
	 ...
	 */
	public List<CustomerVO> getAllUser(Map<String, Object> map);
