...
public class MaterialVO {
	...
	public void setQuestion_solve(String question_solve) {
		this.question_solve = question_solve;
	}
	...
	public int getFiles_name() {
		return files_name;
	}
	public void setFiles_name(int files_name) {
