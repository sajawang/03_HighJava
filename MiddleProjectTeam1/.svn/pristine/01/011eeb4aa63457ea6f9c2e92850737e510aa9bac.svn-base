...
$(function(){
	  function openIdPopup(){
	        window.open("idInput.jsp", "new", "toolbar=no, menubar=no, scrollbars=yes, resizable=no, width=600, height=700, left=0, top=0" );
	    }
	  function openPassPopup(){
	        window.open("passInput.jsp", "new", "toolbar=no, menubar=no, scrollbars=yes, resizable=no, width=600, height=700, left=0, top=0" );
	    }
