...
@WebServlet("/material/detailMaterial.do")
public class DetailMaterial extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/view/material/detailMaterial.jsp").forward(request, response);
