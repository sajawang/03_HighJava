...
$(function(){
	$("#cancel").on("click", function(){
		location.href = "<%=request.getContextPath()%>/goTenMinMath.do";
	});
});
</script>
</head>
...
<form name="tenMinForm" id="tenMinForm" action="<%=request.getContextPath()%>/tenMinuteSubscribeSetting.do" method="post">	
<table border="1">
	<thead>
		<tr>
			<th>목표시간</th>
