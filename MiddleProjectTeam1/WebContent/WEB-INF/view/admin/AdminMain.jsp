    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <ul class="nav-list">
                ...
                <li><a onclick="noticeIframe('worksheet.html')">학습지</a></li>
                <li><a onclick="noticeIframe('daily-math.html')">매일 10분 수학</a></li>
                <li><a onclick="noticeIframe('<%=request.getContextPath()%>/AdminNoticeList.do')">공지사항</a></li>
                <li><a onclick="noticeIframe('math-help.html')">수학 학습 해결소</a></li>
                <li><a onclick="noticeIframe('<%=request.getContextPath()%>/adminInquiriesList.do')">이용 문의 게시판</a></li>
                <li><a onclick="noticeIframe('math-help.html')">선생님 자료실</a></li>
                <li><a onclick="noticeIframe('talk.html')">샘 톡톡 (Talk Talk)</a></li>
            </ul>
        </div>
