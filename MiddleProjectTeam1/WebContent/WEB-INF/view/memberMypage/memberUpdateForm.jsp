...
%>
<h2>회원 정보 수정 </h2>
<form id="ff" action="<%=request.getContextPath()%>/MemberUpdate.do" method='post'>
	<input type="hidden" name="cus_id" value="<%=memVo.getCus_id()%>">
	<input type="hidden" name="mem_name" value="<%=memVo.getMem_name()%>">
	<input type="hidden" name="mem_bir" value="<%=memVo.getMem_bir()%>">
	<input type="hidden" name="mem_point" value="<%=memVo.getMem_point()%>">
	<input type="hidden" name="mem_auth" value="<%=memVo.getMem_auth()%>">
<table border="1">
<tbody>
	<tr>
		<td>아이디</td>
	...
	<tr>
		<td>주소</td>
		<td>
			<input type="text" id="sample6_postcode" placeholder="우편번호" value="<%=memVo.getMem_zip()%>" name="mem_zip">
			<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
			<input type="text" id="sample6_address" placeholder="주소" value="<%=memVo.getMem_add1()%>" name="mem_add1"><br>
			<input type="text" id="sample6_detailAddress" placeholder="상세주소" value="<%=memVo.getMem_add2()%>" name="mem_add2">
			<input type="text" id="sample6_extraAddress" placeholder="참고항목" value="(<%=memVo.getMem_add2()%>)"><br>
	...
	<tr>
		<td>이메일</td>
		<td>
			<input type="text" name="mem_mail" value="<%=memVo.getMem_mail()%>" id="mem_mail">
	...
	<tr>
		<td>휴대폰</td>
		<td>
			<input type="text" name="mem_tel" value="<%=memVo.getMem_tel()%>" id="mem_tel">
			<span id="memtel-error"></span>
		</td>
	</tr>
	<tr>
		<td>교사 인증 정보</td>
		<td><input type="text" name="mem_certi" value="<%=memVo.getMem_auth()%>"></td>
	</tr>
	<tr>
